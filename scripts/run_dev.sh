...
DOCKER_ARGS+=("-v ~/docker/isaac-sim/cache/ov:/root/.cache/ov:rw")
DOCKER_ARGS+=("-v ~/docker/isaac-sim/cache/kit:/isaac-sim/kit/cache:rw")
DOCKER_ARGS+=("-v ~/docker/isaac-sim/cache/pip:/root/.cache/pip:rw")
DOCKER_ARGS+=("-v ~/docker/isaac-sim/cache/glcache:/root/.cache/nvidia/GLCache:rw")
DOCKER_ARGS+=("-v ~/docker/isaac-sim/cache/computecache:/root/.nv/ComputeCache:rw ")
DOCKER_ARGS+=("-v ~/docker/isaac-sim/logs:/root/.nvidia-omniverse/logs:rw")
DOCKER_ARGS+=("-v ~/docker/isaac-sim/data:/root/.local/share/ov/data:rw")
